$(function () {
    ...
    var player = { PlayerName: playerName, prevW: false, prevA: false, prevS: false, prevD: false, Location: { X:50, Y:50 } };
    ...
    function Draw(obj, ctx) {
        //ctx.font = "16px Arial";
        //ctx.drawImage(img, 0, 0, 32, 32, obj.Location.X, obj.Location.Y, 32, 32);
        //ctx.fillText(obj.PlayerName, obj.Location.X + 12, obj.Location.Y);
        ...
        if (obj.PlayerName == player.PlayerName) {
            ...
            ctx.drawImage(img, 0, 0, 32, 32, 328 + player.Location.X - obj.Location.X, 208, 32, 32);
        }
